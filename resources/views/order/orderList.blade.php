...
<div>
    <div class="g-pay-lst">
        <ul>
            @foreach( $detail_arr as $v )
                <li order_id="{{$v -> order_id}}">
                    <a href="">
                            <span>
                                <img src="./uploads/goods/goods_thumb/20181013/11c7397df7473ccc387b2f2c3b0b668f.jpg" border="0" alt="">
                            </span>
                        <dl>
                            <dt>
                            ...
                            <dd>
                                <em class="price">{{$v -> buy_number}}</em>个/
                                ￥:<em class="num">{{$v -> goods_price}}</em>
                            </dd>
                        </dl>
                    </a>
                </li>
        ...
        <p class="gray9">总需支付金额：
            <em class="orange">
                <i>{{$order_arr -> order_amount}}</i>
            </em>
        </p>
    </div>
    ...
    <div class="other_pay marginB">
        ...
        <a href="javascript:;" class="method chaomoney">
            <i></i>潮购值抵扣：
            <span class="gray9">(可用潮购值<em>100</em>)</span>
            <em class="orange fr"></em>
        </a>
        <a href="javascript:;" class="method leftmoney">
            <i></i>账户总额：
            <span class="gray9">(￥<em>0.00</em>)</span>
            <em class="orange fr"></em>
        </a>
        <a href="javascript:;" class="wzf checked">
            <b class="z-set"></b>第三方支付
            <em class="orange fr"><span class="colorbbb">需要支付&nbsp;
                </span>
                <b>￥</b>1.00
            </em>
        </a>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            for(var i = 0;i<$('.g-pay-lst li').length;i++){
                ...
                total +=parseInt($('.g-pay-lst li').eq(i).find('dd em.price').text() * $('.g-pay-lst li').eq(i).find('dd em.num').text());
